...
static struct l2_level l2_freq_tbl[] __initdata = {
	...
	[2]  = { {  432000, HFPLL, 2, 0x20 }, 1050000, 1050000, 2 },
    [3]  = { {  486000, HFPLL, 2, 0x24 }, 950000,  950000, 2 },
    [4]  = { {  540000, HFPLL, 2, 0x28 }, 950000,  950000, 2 },
    [5]  = { {  594000, HFPLL, 1, 0x16 }, 950000,  950000, 2 },
    [6]  = { {  648000, HFPLL, 1, 0x18 }, 950000,  950000, 4 },
    [7]  = { {  702000, HFPLL, 1, 0x1A }, 950000,  950000, 4 },
    [8]  = { {  756000, HFPLL, 1, 0x1C }, 1050000, 1050000, 4 },
    [9]  = { {  810000, HFPLL, 1, 0x1E }, 1050000, 1050000, 4 },
    [10] = { {  864000, HFPLL, 1, 0x20 }, 1050000, 1050000, 4 },
    [11] = { {  918000, HFPLL, 1, 0x22 }, 1050000, 1050000, 5 },
    [12] = { {  972000, HFPLL, 1, 0x24 }, 1050000, 1050000, 5 },
    [13] = { { 1026000, HFPLL, 1, 0x26 }, 1050000, 1050000, 5 },
    [14] = { { 1080000, HFPLL, 1, 0x28 }, 1050000, 1050000, 5 },
    [15] = { { 1134000, HFPLL, 1, 0x2A }, 1050000, 1050000, 5 },
#endif
	{ }
};
...
static struct acpu_level tbl_slow[] __initdata = {
	...
	{ 0, {   972000, HFPLL, 1, 0x24 }, L2(11),  1125000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(12), 1125000 },
	{ 0, {  1080000, HFPLL, 1, 0x28 }, L2(13), 1175000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(13), 1175000 },
...
static struct acpu_level tbl_nom[] __initdata = {
...
#endif
	{ 0, {   432000, HFPLL, 2, 0x20 }, L2(1),   925000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(2),   925000 },
	{ 0, {   540000, HFPLL, 2, 0x28 }, L2(3),   950000 },
	...
	{ 0, {   972000, HFPLL, 1, 0x24 }, L2(11),  1075000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(12),  1075000 },
	{ 0, {  1080000, HFPLL, 1, 0x28 }, L2(13), 1125000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(13), 1125000 },
...
static struct acpu_level tbl_fast[] __initdata = {
...
#endif
	{ 0, {   432000, HFPLL, 2, 0x20 }, L2(1),   875000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(2),   875000 },
	{ 0, {   540000, HFPLL, 2, 0x28 }, L2(3),   900000 },
	...
	{ 0, {   972000, HFPLL, 1, 0x24 }, L2(11),  1025000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(12),  1025000 },
	{ 0, {  1080000, HFPLL, 1, 0x28 }, L2(13), 1075000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(13), 1075000 },
...
static struct acpu_level tbl_faster[] __initdata = {
	...
	{ 0, {   864000, HFPLL, 1, 0x20 }, L2(9),   975000 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(10),   975000 },
	{ 0, {   972000, HFPLL, 1, 0x24 }, L2(11),  1000000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(12),  1000000 },
	{ 0, {  1080000, HFPLL, 1, 0x28 }, L2(13), 1050000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(13), 1050000 },
